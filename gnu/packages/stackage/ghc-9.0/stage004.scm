;;; generated file
(define-module (gnu packages stackage ghc-9.0 stage004)
...
(define-public haskell-9.0-HDBC
  (package
    (name "haskell-9.0-HDBC")
    (version "2.4.0.4")
    (source (origin
              (method url-fetch)
...
(define-public haskell-9.0-ListLike
  (package
    (name "haskell-9.0-ListLike")
    (version "4.7.7")
    (source (origin
              (method url-fetch)
              (uri (string-append
              ...
              (sha256
               (base32
                "0h4yfzrf3ljvzf3x75nx791bpxlmdi7f42ff0xyfk8d498iws08a"))))
    ...
    (arguments
     `(#:tests? #t
       ...
       #:cabal-revision
       ("1" "155y1r051ar9k8vhb54q5ga7a5rzlm4jx1c42pbw7cfy3c8af6hc")))
    (outputs (list "out" "static" "doc"))
...
(define-public haskell-9.0-arrows
  (package
    (name "haskell-9.0-arrows")
    (version "0.4.4.2")
    (source (origin
              (method url-fetch)
...
(define-public haskell-9.0-assoc
  (package
    (name "haskell-9.0-assoc")
    (version "1.0.2")
    (source (origin
              (method url-fetch)
...
(define-public haskell-9.0-c2hs
  (package
    (name "haskell-9.0-c2hs")
    (version "0.28.8")
    (source (origin
              (method url-fetch)
...
(define-public haskell-9.0-cabal-clean
  (package
    (name "haskell-9.0-cabal-clean")
    ...
    (source (origin
              ...
              (sha256
               (base32
                "10kw1d6gxksgawpklqmjhbdc507zcxsghnf6vjwiv2wikrmz8b0d"))))
...
haskell-9.0-cabal-clean

(define-public haskell-9.0-crypto-cipher-types
  (package
    (name "haskell-9.0-crypto-cipher-types")
    (version "0.0.9")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-crypto-enigma
  (package
    (name "haskell-9.0-crypto-enigma")
    (version "0.1.1.6")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
haskell-9.0-crypto-enigma

(define-public haskell-9.0-crypto-random
  (package
    (name "haskell-9.0-crypto-random")
    (version "0.0.9")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-cubicspline
  (package
    (name "haskell-9.0-cubicspline")
    (version "0.1.2")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
haskell-9.0-cubicspline

(define-public haskell-9.0-data-default-instances-dlist
  (package
    (name "haskell-9.0-data-default-instances-dlist")
    (version "0.0.1")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-data-sketches-core
  (package
    (name "haskell-9.0-data-sketches-core")
    (version "0.1.0.0")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-dlist-instances
  (package
    (name "haskell-9.0-dlist-instances")
    (version "0.1.1.1")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-errors
  (package
    (name "haskell-9.0-errors")
    (version "2.3.0")
    (source (origin
              (method url-fetch)
...
(define-public haskell-9.0-hmatrix-repa
  (package
    (name "haskell-9.0-hmatrix-repa")
    (version "0.1.2.2")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
haskell-9.0-hmatrix-repa

(define-public haskell-9.0-hspec-meta
  (package
    (name "haskell-9.0-hspec-meta")
    (version "2.7.8")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-hstatistics
  (package
    (name "haskell-9.0-hstatistics")
    (version "0.3.1")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-mbox
  (package
    (name "haskell-9.0-mbox")
    (version "0.3.4")
    (source (origin
              (method url-fetch)
...
(define-public haskell-9.0-midair
  (package
    (name "haskell-9.0-midair")
    (version "0.2.0.1")
    (source (origin
              (method url-fetch)
...
(define-public haskell-9.0-mwc-probability
  (package
    (name "haskell-9.0-mwc-probability")
    (version "2.3.1")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-mwc-random-monad
  (package
    (name "haskell-9.0-mwc-random-monad")
    (version "0.7.3.1")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
haskell-9.0-mwc-random-monad

(define-public haskell-9.0-optparse-generic
  (package
    (name "haskell-9.0-optparse-generic")
    (version "1.4.8")
    (source (origin
              (method url-fetch)
              (uri (string-append
              ...
              (sha256
               (base32
                "108sjvjqmq2rps5x7yry0j17qyq4m0gpgxnnzc1i9cjrbhnqcida"))))
    ...
    (arguments
     `(#:tests? #t
       ...
       #:configure-flags (list)
       #:cabal-revision
       ("1" "0rgh8sy2w7rh5n1sz0jxcq892myplbli15snggi77dflv00ic7zd")))
    (outputs (list "out" "static" "doc"))
...
(define-public haskell-9.0-profunctors
  (package
    (name "haskell-9.0-profunctors")
    (version "5.6.2")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-random-bytestring
  (package
    (name "haskell-9.0-random-bytestring")
    (version "0.1.4")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-repa-io
  (package
    (name "haskell-9.0-repa-io")
    (version "3.4.1.2")
    (source (origin
              (method url-fetch)
    ...
    (arguments
     `(#:tests? #t
       ...
       #:configure-flags (list)))
    (outputs (list "out" "static" "doc"))
    (inputs (list (@ (gnu packages stackage ghc-9.0 stage000) haskell-9.0-bmp)
                  (@ (gnu packages stackage ghc-9.0 stage001)
                     haskell-9.0-old-time)
                  (@ (gnu packages stackage ghc-9.0 stage003) haskell-9.0-repa)
                  (@ (gnu packages stackage ghc-9.0 stage001)
...
(define-public haskell-9.0-simple-cmd-args
  (package
    (name "haskell-9.0-simple-cmd-args")
    (version "0.1.8")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-sql-words
  (package
    (name "haskell-9.0-sql-words")
    (version "0.1.6.4")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
haskell-9.0-sql-words

(define-public haskell-9.0-test-framework-hunit
  (package
    (name "haskell-9.0-test-framework-hunit")
    (version "0.3.0.2")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-test-framework-leancheck
  (package
    (name "haskell-9.0-test-framework-leancheck")
    (version "0.0.4")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
haskell-9.0-test-framework-leancheck

(define-public haskell-9.0-test-framework-quickcheck2
  (package
    (name "haskell-9.0-test-framework-quickcheck2")
    (version "0.3.0.5")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-text-postgresql
  (package
    (name "haskell-9.0-text-postgresql")
    (version "0.0.3.1")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
haskell-9.0-text-postgresql

(define-public haskell-9.0-unicode-show
  (package
    (name "haskell-9.0-unicode-show")
    (version "0.1.1.1")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-utility-ht
  (package
    (name "haskell-9.0-utility-ht")
    (version "0.0.16")
    (source (origin
              (method url-fetch)
              (uri (string-append
...
(define-public haskell-9.0-xml-to-json-fast
  (package
    (name "haskell-9.0-xml-to-json-fast")
    (version "2.0.0")
    (source (origin
              (method url-fetch)
              (uri (string-append
